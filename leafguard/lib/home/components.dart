    ...
    return Center(
      child: ClipRRect(
          ...
          child: Stack(
            ...
            children: [
              Image.asset(
                "assets/images/potato-farm.jpeg",
                width: 500,
                height: 200,
                fit: BoxFit.cover,
              ),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
          ...
          border: Border.all(color: Color(0xFF93B183), width: 1),
          borderRadius: BorderRadius.circular(10)),
      child: Column(
              ...
              children: [
                ...
                Expanded(
                    child: Column(
                      ...
                      Text(
                        "Over 10000+ potato farmers trust us for better results.",
            ...
            SizedBox(
              ...
              child: OutlinedButton(
                ...
                style: OutlinedButton.styleFrom(
                    ...
                    side: BorderSide(color: Color(0xFF93B183), width: 1)),
                child: Text(
            ...
            child: Column(
              ...
              children: [
                CircularProgressIndicator(
                  valueColor: AlwaysStoppedAnimation<Color>(Color(0xFF93B183)),
                ),
                SizedBox(height: 15),
                Text(
                  "Scanning your image...",
      ...
      children: [
        UploadCard(
            ...
            requestGalleryPermission:
                isLoading ? () {} : _requestGalleryPermission),
        SizedBox(height: 20),
        ScanCard(
            imageBytes: _imageBytes,
